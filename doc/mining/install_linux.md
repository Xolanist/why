...
Download why node from [https://github.com/whyproject/why-node/releases/latest]. We are assuming that the resulting file will be located at `~/Downloads/why-node-XXXXX-linux-amd64.tar.gz`.

Download why-wallet from [https://github.com/whyproject/why-wallet/releases/latest]. We are assuming that the resulting file will be located at `~/Downloads/why-wallet-XXXXX-linux-amd64.tar.gz`.
...
cd ~/my_why_install
tar -xvf ~/Downloads/why-node-*-linux-amd64.tar.gz
tar -xvf ~/Downloads/why-wallet-*-linux-amd64.tar.gz
```

Your output should be something like this:
```
kbay$ mkdir ~/my_why_install
kbay$ cd ~/my_why_install
my_why_install kbay$ tar -xvf ~/Downloads/why-node-*-linux-amd64.tar.gz
x why/
x why/why
my_why_install kbay$ tar -xvf ~/Downloads/why-wallet-*-linux-amd64.tar.gz
x why-wallet/
x why-wallet/why-wallet
```

Now your why-node is located at `~/my_why_install/why/why` and your why-wallet is located at `~/my_why_install/why-wallet/why-wallet`.
...
```
kbay$ ~/my_why_install/why/why
```

![](Install_mac_images/scr_node.png)


why-node has few commands. Run `~/my_why_install/why/why help` to explore them.
...
```
>  cat ~/.why/main/why-server.log | grep 'ERROR'
``` 
...
```
kbay$ ~/my_why_install/why-wallet/why-wallet --help
why-wallet 2.4.5
The Grin Team
...
```
Any command can be explored by running `help <command>`. For example this command will show you details for 'init':  `~/my_why_install/why-wallet/why-wallet help init`


To create the new wallet please run command below. We strongly recommend to setup the password for your seed. 
```
kbay$ ~/my_why_install/why-wallet/why-wallet init
Please enter a password for your new wallet
Password:
Confirm Password:
20191111 18:13:13.180 WARN grin_wallet_impls::seed - Generating wallet seed file at: ~/.why/main/wallet_data/wallet.seed
...
```
kbay$ ~/my_why_install/why-wallet/why-wallet init -r
...
Password:
Confirm Password:
20191111 18:17:49.394 WARN grin_wallet_impls::seed - Generating wallet seed file at: ~/.why/main/wallet_data/wallet.seed
Your recovery phrase is:
...
kbay$ ~/my_why_install/why-wallet/why-wallet check
Password:
...
```
>  cat ~/.why/main/why-wallet.log | grep 'ERROR'
```
...
```
kbay$ ~/my_why_install/why-wallet/why-wallet listen
Password:
...
```
> cat ~/.why/main/why-server.log | grep 'Stratum server started'
...
```
~/my_why_install/why-wallet/why-wallet info
```

You can check your outputs with `outputs`
```
~/my_why_install/why-wallet/why-wallet output
```
