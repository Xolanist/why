...
Download why node from [https://github.com/whyproject/why-node/releases/latest]. We are assuming that the resulting file will be located at `~/Downloads/why-node-XXXXX-macos.tar.gz`.

Download why-wallet from [https://github.com/whyproject/why-wallet/releases/latest]. We are assuming that the resulting file will be located at `~/Downloads/why-wallet-2.4.5-macos.tar.gz`.
...
cd ~/my_why_install
tar -xvf ~/Downloads/why-node-*-macos.tar.gz
tar -xvf ~/Downloads/why-wallet-*-macos.tar.gz
```
...
my_why_install kbay$ tar -xvf ~/Downloads/why-node-*-macos.tar.gz
x why/
x why/why
my_why_install kbay$ tar -xvf ~/Downloads/why-wallet-*-macos.tar.gz
x why-wallet/
