...
use crate::consensus::{self, calc_why_block_overage, calc_why_block_reward, reward};
...
impl BlockHeader {
	...
	pub fn overage(&self) -> i64 {
		// MWC strategy
		(calc_why_block_reward(self.height) as i64)
			.checked_neg()
			.unwrap_or(0)
	}
	...
	pub fn total_overage(&self, genesis_had_reward: bool) -> i64 {
		...
		*/
		...
		// MWC strategy:
		(calc_why_block_overage(reward_count, genesis_had_reward) as i64)
			.checked_neg()
			.unwrap_or(0)
	}
